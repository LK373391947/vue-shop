...
/* 4 */
/*!******************************************************************!*\
  !*** D:/HBuilderX.2.6.16.20200424.full/vuepro/waimai/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!****************************************************************!*\
  !*** D:/HBuilderX.2.6.16.20200424.full/vuepro/waimai/store.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    //减少
    subToCart: function subToCart(state, obj) {
      var len = state.cart.length;
      for (var i = 0; i < len; i++) {
        if (state.cart[i].name == obj.name)
        {
          if (state.cart[i].num > 1) {state.cart[i].num--;state.total -= Number(obj.price);break;} else
          {state.cart.splice(i, 1);state.total -= Number(obj.price);break;}
        }
      }

    },
    //删除
    deleteItem: function deleteItem(state, obj) {
      var len = state.cart.length;
      for (var i = 0; i < len; i++) {
        if (state.cart[i].name == obj.name) {
